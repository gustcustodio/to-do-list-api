...
INSERT INTO tb_item(title, description, user_id) VALUES ('Gym session', 'Upper body workout and 20 minutes of cardio', 2);
INSERT INTO tb_item(title, description, user_id) VALUES ('Clean the house', 'Vacuum the living room and wash the dishes', 2);